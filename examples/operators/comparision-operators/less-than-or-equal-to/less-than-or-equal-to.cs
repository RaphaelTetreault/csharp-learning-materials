...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Is {number1} less than or equal to {9}? {number1 <= 9}.");
        Console.WriteLine($"Is {number1} less than or equal to {10}? {number1 <= 10}.");
        
        // We can compare variables to other variables. This is very useful!
        Console.WriteLine($"Is {number1} less than or equal to {number2}? {number1 <= number2}.");
        ...
        Console.WriteLine($"Is {number2} less than or equal to {number3}? {number2 <= number3}.");
    }
}