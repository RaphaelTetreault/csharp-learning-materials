...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Is {number1} less than {9}? {number1 < 9}.");
        Console.WriteLine($"Is {number1} less than {10}? {number1 < 10}.");
        ...
        Console.WriteLine($"Is {number2} less than {number3}? {number2 < number3}.");
    }
}